      ...
      <div class="w-full px-20 pr-72 ">
        ...
        <form class="mt-8 space-y-6" action="#" method="POST">
          ...
          <div class="flex justify-start">
            <button @click="createNotRec" type="submit" class=" w-40 group relative flex w-full justify-center rounded-md border border-transparent py-2 px-4 text-sm font-medium text-white bg-tertiary ">
              Submit
            </button>
          </div>
        </form>
