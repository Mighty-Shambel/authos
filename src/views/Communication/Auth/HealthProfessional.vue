...
<div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 p-10 lg:pt-5 lg:pl-20 bg-white ">
...
<path d="M 2 4 C 1 4 1 5 2 5 C 1 5 1 6 2 6 C 1 6 1 7 2 7 C 1 7 1 8 2 8 C 1 8 1 9 2 9 C 1 9 1 10 2 10 M 7 5" fill=""/>
    ...
    <div>
      <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Health Professional</h2>
    </div>
