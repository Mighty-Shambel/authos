<template>
    <div class=" h-screen grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 bg-gradient-to-l from-primary  p-20 pl-40 pr-40">
    <div class="grid grid-cols-1 md:gird-cols-1 lg:grid-cols-2 shadow-2xl">
  
  <social-media></social-media>
    <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 p-10 lg:pt-40 lg:pl-20 md:pt-10 bg-white  ">
